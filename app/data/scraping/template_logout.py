...
# TODO: genre/●●●● を変更
url = 'https://www.netflix.com/jp/browse/genre/1365'
# URLにアクセスする
...
# TODO: /action_adventure/action_adventure.csv を変更
df.to_csv('app/data/csv/action_adventure/action_adventure.csv')
